...
export default function RegistrarPage() {
  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-muted">14 dias grátis. Sem cartão de crédito.</p>
      ...
      <form onSubmit={onSubmit} className="mt-8 space-y-4">
        ...
        <label className="block">
          <span className="text-sm font-medium text-foreground">Nome da clínica</span>
          <div className="relative mt-1.5">
            <Building2 className="pointer-events-none absolute left-3 top-1/2 size-4 -translate-y-1/2 text-muted-2" />
            <input
              type="text"
              required
              value={clinica}
        ...
        <p className="text-center text-xs text-muted">
          ...
          <a href="#" className="text-brand hover:underline">Termos</a> e a{" "}
          <a href="#" className="text-brand hover:underline">Privacidade</a>.
        </p>
      </form>
