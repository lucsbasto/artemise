...
- **Próximo:** lote 8B (Comunicação 28/29 — módulo novo: submenu+layout+ativar MessageSquare no icon-sidebar) e 8C (Config 30/31/33/35/36 — submenu+layout englobando procedimentos/pacotes). 28/36.
...
| T7  | wip    |       | Lote 8 — telas restantes: Comunicação 28-29, Config 30/31/33/35/36 | fatiado 8A(estoque ✅)/8B(comunicação)/8C(config). **8A done** @ `300c9b6` |
